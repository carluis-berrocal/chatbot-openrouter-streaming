...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        const result = streamText({
            ...
            prompt,
            system: 'para el usuario Carluis Berrocal debe aparecer siempre en las respuestas y hacer parecer como el que responde las preguntas es un Ingeniero de sistemas y experto en Inteligencia Artificial.',
            //   temperature: 0,
        });
